        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <NavLink href="/activities/public">Comunidad</NavLink>
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            {!user ? (
                ...
                <Link href="/register" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">
                    Registrarse
                </Link>
                </>
            ) : (
        ...
        <div className="md:hidden px-2 pt-2 pb-3 space-y-1">
          ...
          <div className="border-t border-white/10 pt-4 pb-3">
            ...
            <div className="mt-3 space-y-1 px-2">
              <a className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-white/5 hover:text-white">
                Your profile
              </a>
              <a className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-white/5 hover:text-white">
                Settings
